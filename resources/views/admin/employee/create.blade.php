                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                                ...
                                                <div class="input-group" >
                                                    <input class="form-control form-control-lg datepickers" data-date-format="yyyy-mm-dd"  name="date_of_joining" value="{{ old('date') }}">
                                            ...
                                            <div class="form-group {{ $errors->has('about') ? 'has-error' : '' }}">
                                                ...
                                                <textarea class="form-control form-control-lg" id="about" rows="3" name="about" placeholder="Express yourself" data-autosize="true">{{old('about')}}</textarea>
                                                @if ($errors->has('about'))
                                                    <span class="text-danger">
                                                {{ $errors->first('about') }}
                                                 </span>
